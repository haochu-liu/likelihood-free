...
iter_weight <- theta_smc_c$weight[10, ]
iter_mat <- theta_smc_c$theta[, , 9]
...
for (i in 1:5) {
  theta_density <- density(theta_smc_c$theta[1, ,i], bw = 0.5,
                           weights = exp(theta_smc_c$weight[i, ]))
  plot(theta_density,
...
theta_smc_density <- density(theta_smc_c$theta[1, ,gamma_n], bw = 0.5,
                             weights = exp(theta_smc_c$weight[gamma_n, ]))
