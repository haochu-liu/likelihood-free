...
if __name__ == "__main__":
    ...
    start_index = split_indices[script_number - 1]
    end_index = split_indices[script_number]
    print(f"Running tuning7_{script_number}.py:")
    print("Loading data...")
    ...
    for k in range(start_index, end_index):
        ...
        np.save(str(data_path / 'NPE_tuning/stage7_p_values_{i}.npy'.format(i=script_number)), stage7_p_values)
        np.save(str(data_path / 'NPE_tuning/stage7_D_stats_{i}.npy'.format(i=script_number)), stage7_D_stats)
        np.save(str(data_path / 'NPE_tuning/stage7_maha_errors_{i}.npy'.format(i=script_number)), stage7_maha_errors)
        np.save(str(data_path / 'NPE_tuning/stage7_nll_{i}.npy'.format(i=script_number)), stage7_nll)
