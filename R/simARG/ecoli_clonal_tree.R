...
write.table(edge_full, file="data/ecoli/clonal_edge_new.csv",
            sep = ",", row.names=FALSE, col.names=FALSE)
write.table(node_height, file="data/ecoli/clonal_node_height_new.csv",
            sep = ",", row.names=FALSE, col.names=FALSE)
write.table(t2$tip.label, file="data/ecoli/tip_names.csv",
            sep = ",", row.names=FALSE, col.names=FALSE)

# Save t2
write.tree(phy=t2, file="data/ecoli/ecoli_clonal.nwk")
