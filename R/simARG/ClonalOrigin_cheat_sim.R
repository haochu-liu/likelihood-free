...
summary_stats_mat <- matrix(NA, nrow=9, ncol=1000)
...
points(param_mat[1, ], summary_stats_mat[8, ], pch=4, col="darkblue")
points(param_mat[1, ], summary_stats_mat[9, ], pch=4, col="darkgreen")

plot(param_mat[2, ], summary_stats_mat[7, ], pch=4, col="darkred")
points(param_mat[2, ], summary_stats_mat[8, ], pch=4, col="darkblue")
points(param_mat[2, ], summary_stats_mat[9, ], pch=4, col="darkgreen")

plot(param_mat[3, ], summary_stats_mat[7, ], pch=4, col="darkred")
points(param_mat[3, ], summary_stats_mat[8, ], pch=4, col="darkblue")
points(param_mat[3, ], summary_stats_mat[9, ], pch=4, col="darkgreen")
