...
#| echo: true
# Example Matrix
my_matrix <- matrix(rnorm(9), nrow = 3, 
...
df %>%
  ...
  tab_stubhead(label = "Parameters") %>%  # <--- Label for the Row Names
  tab_spanner(label = "Sample Sizes (n)", columns = everything()) %>% # <--- Label for Columns
  tab_header(title = "MCMC Convergence Results")
```
